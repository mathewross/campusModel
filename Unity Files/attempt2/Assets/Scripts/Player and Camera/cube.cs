...
public class cube : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (grounded)
        {
            ...
            if (camera1.transform.gameObject.transform.GetComponent<cameraFollow>().inFirstPerson == true)
            {
        ...
        if (camera1.transform.gameObject.transform.GetComponent<cameraFollow>().inFirstPerson == false)
        {
